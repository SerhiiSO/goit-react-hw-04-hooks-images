...
import fetchImages from './APIcomponent/pixabayApi';
...
export default class App extends Component {
  ...
  handleSubmit = event => {
    ...
    const inputValue = event.target.elements.inputToFind.value
      .toLowerCase()
      .trim();
  ...
  render() {
    const { images, status, showModal, modalLargeImage, modalLargeAlt } =
      this.state;
